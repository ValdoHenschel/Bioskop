...
public class StudioList extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					StudioList frame = new StudioList();
	 ...
	 */
	public StudioList() throws SQLException, ParseException {
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					new studio1(id_studio).setVisible(true);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					new studio2("S002").setVisible(true);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		btnLogout.setBounds(556, 11, 105, 63);
		contentPane.add(btnLogout);

		JLabel lblSelamatBekerja = new JLabel("SELAMAT BEKERJA");
		lblSelamatBekerja.setForeground(Color.RED);
		lblSelamatBekerja.setFont(new Font("Tw Cen MT Condensed", Font.BOLD, 30));
		lblSelamatBekerja.setBounds(26, 396, 635, 63);
		contentPane.add(lblSelamatBekerja);
	}
